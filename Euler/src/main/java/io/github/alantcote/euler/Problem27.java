...
/**
 * A solution for Project Euler Problem 27. The problem statement is
...
//							"len = " + len + "; a = " + a + "; b = " + b);
	...
	/**
	 * Find the value <tt>f = n * n + a * n + b</tt>. where <tt>abs(a) < 1000</tt>
	 * and <tt>abs(b) < 1000</tt>, and <tt>n > -1</tt>.
	 * 
	 * @param n
	 * @param a
	 * @param b
