...
public class Problem11 {
	public enum Dir {
		DOWN, NEG_SLOPE, POS_SLOPE, RIGHT
	};

	public static final long[][] GRID = { { 8, 2, 22, 97, 38, 15, 0, 40, 0, 75, 4, 5, 7, 78, 52, 12, 50, 77, 91, 8 },
	...
	protected static long[] sequence(Dir dir, int length, int baseX, int baseY) {
		long[] seq = null;
