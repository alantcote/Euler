 ...
 * <b>Spoiler Alert</b>
 * 
 * The verified correct result is 23514624000.
 */
public class Problem8 {
	 ...
	 */
	public static long largestProduct(String digits, int window) {
		...
		for (int i = 0; i < nDigits - window; ++i) {
			...
			if (product > largest) {
				...
				System.out.println(digit[i + window - 1]);
			}
		}
	...
	public static void main(String[] args) {
		long bigProd = largestProduct(THOUSAND_DIGITS, WINDOW_SIZE);
